...
<head>
 ...
 <style>
        * {
        ...
        .tabela tr.grouprow2, .tabela td.groupcol2 {
            background-color: #ebe0ff;
            font-weight: bold;
        }

        .tabela tr.grouprow3, .tabela td.groupcol3 {
        ...
        .tabela td.destaque, .tabela tr.destaque {
            background-color: #ffeb3b;
        }

        .tabela tr.success, .tabela td.success {
            background-color: #4caf50;
        }

        .tabela td.destaqueRed, .tabela tr.destaqueRed {
        ...
        * {
        ...
        .header .title, .header .subtitle, .header .data {
            font-size: 14px;
            right: 0;
            text-align: right;
            margin-bottom: 5px;
