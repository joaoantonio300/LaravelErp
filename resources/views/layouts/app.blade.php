        ...
        <div class="sidebar" id="sidebar">
            ...
            <nav class="nav flex-column">
                ...
                <a class="nav-link" href="{{ route('roles.index') }}">
                    <i class="bi bi-shield-lock"></i><span>Perfil</span>
                </a>
                @endcan

                @can('movimentacoes.view')
                <a class="nav-link" href="{{ route('movimentacaos.index') }}">
                ...
                <a class="nav-link" href="{{ route('relatorios.index') }}">
                    <i class="bi bi-file-text"></i><span>Relatórios</span>
                </a>
                @endcan
